...
#else
    #define beautyResourceName  @"ComposeMakeup/beauty_IOS_live"
    #define reshapeResourceName  @"ComposeMakeup/reshape_live"
    #define eyebrowPath  @"eyebrow/"
    #define blushPath  @"blush/"
    #define lipPath  @"lip/"
    #define defaultFacial @"facial/xiurong01"
#endif
