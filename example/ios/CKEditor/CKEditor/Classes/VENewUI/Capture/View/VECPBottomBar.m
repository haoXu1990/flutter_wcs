...
- (UIButton *)filterButton
{
    if (!_filterButton) {
        ...
        [_filterButton setImage:@"icon_bottombar_filter".UI_VEToImage forState:UIControlStateNormal];
...
-(UIButton *)duetButton
{
    if (!_duetButton) {
        ...
        [_duetButton setImage:@"icon_duet_leftright".UI_VEToImage forState:UIControlStateNormal];
...
- (void)duetButtonDidClicked:(UIButton *)button
{
    ...
    [[VEResourceLoader new] duetValueArr:^(NSArray<DVEEffectValue *> * _Nullable datas, NSString * _Nullable error) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            NSArray <NSString *>*imgNames = @[@"icon_duet_leftright", @"icon_duet_updown", @"icon_duet_three"];
            if (i < imgNames.count) {
                [button setImage:imgNames[i].UI_VEToImage forState:UIControlStateNormal];
            }
