...
- (void)textTemplateCategory:(DVEResourceCategoryLoadHandler)hander{
    ...
    NSString *bundleName = @"TextTemplate";
    NSMutableArray* array = [NSMutableArray array];

    NSArray *names = @[@"text_template_hot.json", ];
...
- (void)maskModel:(DVEResourceModelLoadHandler)hander{
    ...
    if(hander){
        ...
        NSDictionary *modelDic = [self jsonObjWithJsonPath:@"videomask.json" withBunle:@"videomask"];
        NSArray *listArr = [[modelDic objectForKey:@"resource"] objectForKey:@"list"];
        NSMutableArray* modelArr = [NSMutableArray arrayWithCapacity:listArr.count];
        ...
        for(NSDictionary* m in listArr){
            ...
            eValue.name = [VEResourceLoader curNameWithDic:m];
            eValue.identifier = eValue.name;
            eValue.sourcePath = [m[@"path"] pathInBundle:@"videomask"];
            eValue.imageURL = [NSURL fileURLWithPath:[m[@"icon"] pathInBundle:@"videomask"]];
            eValue.mask = m[@"mask"];
            [modelArr addObject:eValue];
        }
        hander(modelArr,nil);
...
- (void)audioChangModel:(DVEResourceModelLoadHandler)hander
{
    if(hander){
        ...
        NSDictionary *modelDic = [self jsonObjWithJsonPath:@"audio_filter.json" withBunle:@"audio_filter"];
        NSArray *listArr = [[modelDic objectForKey:@"resource"] objectForKey:@"list"];
        NSMutableArray* modelArr = [NSMutableArray arrayWithCapacity:listArr.count];
        ...
        for(NSDictionary* m in listArr){
            ...
            eValue.name = [VEResourceLoader curNameWithDic:m];
            eValue.identifier = eValue.name;
            eValue.sourcePath = [m[@"path"] pathInBundle:@"audio_filter"];
            eValue.imageURL = [NSURL fileURLWithPath:[m[@"icon"] pathInBundle:@"audio_filter"]];
            [modelArr addObject:eValue];
        }
        hander(modelArr,nil);
    }
...
- (void)textAlignModel:(DVEResourceModelLoadHandler)hander {
    if(hander){
        ...
        NSDictionary *textAlignDict = [self jsonObjWithJsonPath:@"align.json" withBunle:@"Text"];
        ...
        for (NSDictionary *textAlign in textAlignList) {
            ...
            model.identifier = model.name;
            model.sourcePath = [textAlign[@"path"] pathInBundle:@"Text"];
            model.imageURL = [NSURL fileURLWithPath:[textAlign[@"icon"] pathInBundle:@"Text"]];
...
- (void)textColorModel:(DVEResourceModelLoadHandler)hander {
    if(hander){
        ...
        NSDictionary *textColorDict = [self jsonObjWithJsonPath:@"color.json" withBunle:@"Text"];
        ...
        for (NSDictionary *textColor in textColorList) {
            ...
            model.identifier = model.name;
            model.sourcePath = [textColor[@"path"] pathInBundle:@"Text"];
            model.imageURL = [NSURL fileURLWithPath:[textColor[@"icon"] pathInBundle:@"Text"]];
...
- (void)textFontModel:(DVEResourceModelLoadHandler)hander {
    if(hander){
        ...
        NSDictionary *textFontDict = [self jsonObjWithJsonPath:@"font.json" withBunle:@"Text"];
        ...
        for (NSDictionary *textFont in textFontList) {
            ...
            model.sourcePath = [textFont[@"path"] pathInBundle:@"Text"];
            model.imageURL = [NSURL fileURLWithPath:[textFont[@"icon"] pathInBundle:@"Text"]];
            [array addObject:model];
        }
...
- (void)textStyleModel:(DVEResourceModelLoadHandler)hander {
    if(hander){
        ...
        NSDictionary *textStyleDict = [self jsonObjWithJsonPath:@"style.json" withBunle:@"Text"];
        ...
        for (NSDictionary *textStyle in textStyleList) {
            ...
            model.identifier = model.name;
            model.sourcePath = [textStyle[@"path"] pathInBundle:@"Text"];
            model.imageURL = [NSURL fileURLWithPath:[textStyle[@"icon"] pathInBundle:@"Text"]];
...
- (void)curveSpeedResourceModel:(void(^)(NSArray<id<DVEResourceCurveSpeedModelProtocol>>* _Nullable datas, NSError* _Nullable error))handler {
    if (handler) {
        ...
        NSDictionary *curveSpeedDict = [self jsonObjWithJsonPath:@"curvespeed.json" withBunle:@"curvespeed"];
        ...
        for (NSDictionary *curveSpeed in curveSpeedList) {
            ...
            model.identifier = model.name;
            model.imageURL = [NSURL fileURLWithPath:[curveSpeed[@"icon"] pathInBundle:@"curvespeed"]];
