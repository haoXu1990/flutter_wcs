...
//
//        __block NSString *path = [[HTSVideoData cacheDirPath] stringByAppendingString:[NSString stringWithFormat:@"/%@",[NSString VEUUIDString]]];
//        [[TZImageManager manager]  requestVideoURLWithAsset:obj
//                                                   success:^(NSURL *videoURL) {
//            path = [path stringByAppendingString:[NSString stringWithFormat:@".%@",videoURL.pathExtension]];
//            NSFileManager *fileManger = [NSFileManager defaultManager];
//            [fileManger copyItemAtURL:videoURL toURL:[NSURL fileURLWithPath:path] error:nil];
//
//            model.URL = [NSURL fileURLWithPath:path];
//            [VEResourcePicker getResourceWithAssets:assets arr:arr];
//        }
