...
- (void)initKeyFrameObserve {
    //currentTime变化时，需要重置关键帧回调标志位
                ...
                keyFrameInfo:(NLEAllKeyFrameInfo *)info
{
    ...
    NLETrackSlot_OC *resultSlot = [self.nle slotWithCanvasKeyFrameInfo:info.canvasKeyFrames        
                                                                  slot:slot];
