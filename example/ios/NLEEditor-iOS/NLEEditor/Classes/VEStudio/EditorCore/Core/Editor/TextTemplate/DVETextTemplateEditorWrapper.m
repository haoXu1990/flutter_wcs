...
{
    DVELogReport(@"EditorCoreFunctionCalled");
    return [self.textTemplateEditor replaceTemplateAtSlot:slot startTime:startTime endTime:endTime path:path depResModels:depResModels completion:completion];
}
