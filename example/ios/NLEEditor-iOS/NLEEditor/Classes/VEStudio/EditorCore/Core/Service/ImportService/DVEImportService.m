...
- (void)addResources:(NSArray<id<DVEResourcePickerModel>> *)resources
{
    ...
    [self addNLEMainVideoWithResources:resources];
}
...
- (NLETrackSlot_OC *)addSubTrackResource:(id<DVEResourcePickerModel>)resource
{
    ...
    return [self p_addNLESubVideoWithResources:@[resource] targetStartTime:self.vcContext.mediaContext.currentTime layer:(int)maxLayer];
}
...
- (NLETrackSlot_OC *)p_addNLESubVideoWithResources:(NSArray<id<DVEResourcePickerModel>> *)resources
                                             ...
                                             layer:(int)layer
{
    ...
    return [trackSlotArray firstObject];
}
