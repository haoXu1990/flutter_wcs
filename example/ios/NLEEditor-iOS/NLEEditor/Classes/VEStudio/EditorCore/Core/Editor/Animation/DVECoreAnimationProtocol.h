...
typedef NS_ENUM(NSInteger, VEVCModuleCutSubTypeAnimationType) {
    VEVCModuleCutSubTypeAnimationTypeAdmission = 1,
    VEVCModuleCutSubTypeAnimationTypeDisappear = 2,
    VEVCModuleCutSubTypeAnimationTypeCombination = 0,
};
...
- (void)addAnimation:(NSString *)inAnimationPath
          identifier:(NSString *)identifier
            withType:(VEVCModuleCutSubTypeAnimationType)type
