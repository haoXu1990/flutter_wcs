...
- (void)maskKeyFrameDidChanged:(NLESegmentMask_OC *)maskSegment
{
    ...
    dispatch_async(self.serialQueue, ^{
        ...
        if(mask){
            NLESegmentMask_OC *orgMaskSegment = mask.segmentMask;
            orgMaskSegment.width = maskSegment.width;
            orgMaskSegment.height = maskSegment.height;
            orgMaskSegment.feather = maskSegment.feather;
            orgMaskSegment.centerX = maskSegment.centerX;
            orgMaskSegment.centerY = maskSegment.centerY;
            orgMaskSegment.roundCorner = maskSegment.roundCorner;
            orgMaskSegment.rotation = maskSegment.rotation;
        }
