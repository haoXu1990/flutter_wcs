...
- (void)refreshCanvasBorderForKeyFrameIfNeed
{
    ...
    NLETrackSlot_OC *resultSlot = [self.nle slotWithCanvasKeyFrameInfo:keyFrameInfo.canvasKeyFrames
                                                                  slot:slot];
    [self updateCanvasBorderWithSlot:resultSlot];
}
