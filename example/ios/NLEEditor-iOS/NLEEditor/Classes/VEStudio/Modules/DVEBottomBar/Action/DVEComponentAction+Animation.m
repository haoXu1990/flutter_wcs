...
{
    [self openAnimation:VEVCModuleCutSubTypeAnimationTypeAdmission];
...
{
    [self openAnimation:VEVCModuleCutSubTypeAnimationTypeDisappear];
...
{
    [self openAnimation:VEVCModuleCutSubTypeAnimationTypeCombination];
...
-(void)openAnimation:(VEVCModuleCutSubTypeAnimationType)type
{
    CGFloat H = 228 - VEBottomMargnValue + VEBottomMargn;
