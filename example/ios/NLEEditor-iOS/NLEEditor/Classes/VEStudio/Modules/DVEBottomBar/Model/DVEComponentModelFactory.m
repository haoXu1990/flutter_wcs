                                    ...
                                    createSubComponent:(BOOL)create
{
    ...
    switch(type)
    {
        ...
        case DVEBarComponentTypeTextTemplate: {
            model = [DVEComponentModelFactory createComponentModelWithType:type imageName:@"icon_vevc_text_temp" title:NLELocalizedString(@"ck_text_template",@"文字模板") actionName:@"textTemplateComponentOpen:" parent:parent];
            if (create) {
                model.subComponents = [DVEComponentModelFactory parseSubComponentConfig:[DVEComponentModelFactory defaultTextTemplateSubComponent] parent:model createSubComponent:create];
            }
        } break;
        default: {
...
+ (NSArray *)defaultTextTemplateSubComponent
{
    return @[
        ...
        @{kTypeKey:@(DVEBarComponentTypeAction),kTitleKey:NLELocalizedString(@"ck_replace",@"替换"),kImageKey:@"icon_text_template_replace".dve_toImage,kActionKey:@"replaceTextTemplate:",kGroupKey:@(DVEBarSubComponentGroupEdit)},   //替换
        @{kTypeKey:@(DVEBarComponentTypeAction),kTitleKey:NLELocalizedString(@"ck_split",@"拆分"),kImageKey:@"icon_cutsub_chaifen".dve_toImage,kActionKey:@"splitTextTemplate:",kGroupKey:@(DVEBarSubComponentGroupEdit)},    //拆分
        @{kTypeKey:@(DVEBarComponentTypeAction),kTitleKey:NLELocalizedString(@"ck_copy",@"复制"),kImageKey:@"icon_effects_copy".dve_toImage,kActionKey:@"copyTextTemplate:",kGroupKey:@(DVEBarSubComponentGroupEdit)},   //复制
        @{kTypeKey:@(DVEBarComponentTypeAction),kTitleKey:NLELocalizedString(@"ck_edit",@"编辑"),kImageKey:@"icon_vevcbar_edit".dve_toImage,kActionKey:@"editTextTemplate:",kGroupKey:@(DVEBarSubComponentGroupEdit)},   //编辑
        @{kTypeKey:@(DVEBarComponentTypeAction),kTitleKey:NLELocalizedString(@"ck_delete",@"删除"),kImageKey:@"icon_cutsub_delet".dve_toImage,kActionKey:@"deleteTextTemplate:",kGroupKey:@(DVEBarSubComponentGroupEdit)},
    ];
}
