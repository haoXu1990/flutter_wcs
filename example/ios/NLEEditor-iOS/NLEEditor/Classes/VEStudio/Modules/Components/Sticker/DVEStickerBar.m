...
@interface DVEStickerBar () <DVEPickerViewDelegate, DVEStickerCropViewControllerDelegate>
        ...
        switch (indexPath.row) {
            ...
            default: {
                ...
                if (self.stickerSlot) {
                    ...
                    [vc.stickerEditAdatper addEditBoxForSticker:self.stickerSlot.nle_nodeId isText:NO];
                }
...
- (void)cropViewController:(DVEStickerCropViewController *)viewController didFinishProcessingImage:(NSString *)imagePath
{
    ...
    DVEViewController *vc = (DVEViewController *)self.parentVC;
    [vc.stickerEditAdatper addEditBoxForSticker:slotId isText:NO];
