...
//        make.height.equalTo(@(170));
    ...
    NSDictionary *params = @{
                            @"creation_id" : self.trackExtraDict[@"creation_id"]?:@"",
                            @"shoot_way" : self.trackExtraDict[@"shoot_way"]?:@"",
                            @"content_type" : self.currentAssetModel.mediaType == DVEAlbumAssetModelMediaTypeVideo ? @"video":@"photo",
                            @"is_selected" : [self.selectedAssetModelArray containsObject:self.currentAssetModel] ? @(1):@(0),
                            };
